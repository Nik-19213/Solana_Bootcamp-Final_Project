...
pub fn mint(
	...
	avn: &mut AccountPDA<AviationNftmetadata>,
	funding: &AccountInfo,
    ...
    avn.data.aircraft_type = aircraft_type;
    avn.data.flight_route = flight_route;
    avn.data.description = description;
    avn.data.mint = *mint.info.key;
    avn.data.assoc_account = Some(*assoc_token_account.key);
