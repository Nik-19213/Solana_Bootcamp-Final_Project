 ...
 *
 * Data:
 * - aircraft_type: {@link string} 
 * - flight_route: {@link string} 
...
export const mint = (args: MintArgs): TransactionInstruction => {
    const data = serialize(
        ...
        {
            id: AvnNftInstruction.Mint,
            aircraft_type: args.aircraftType,
            flight_route: args.flightRoute,
            description: args.description,
        }
    );

    const [avnPubkey] = pda.deriveAviationNftmetadataPDA({
        mint: args.mint,
    }, _programId);
    ...
    return new TransactionInstruction({
        ...
        keys: [
            ...
            {pubkey: avnPubkey, isSigner: false, isWritable: true},
...
export const getAviationNftmetadata = async (
    publicKey: PublicKey,
    commitmentOrConfig: Commitment | GetAccountInfoConfig | undefined = "processed"
): Promise<T.AviationNftmetadata | undefined> => {
    ...
    return T.decodeAviationNftmetadata(deserialize(T.AviationNftmetadataSchema, buffer.data) as Record<string, unknown>);
}
