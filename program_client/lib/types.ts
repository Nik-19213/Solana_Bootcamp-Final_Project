...
export interface AviationNftmetadata {
  aircraftType: string;
  flightRoute: string;
  description: string;
  mint: PublicKey;
...
export const decodeAviationNftmetadata = (decoded: Decoded): AviationNftmetadata => ({
    aircraftType: decoded["aircraft_type"] as string,
    flightRoute: decoded["flight_route"] as string,
...
export const AviationNftmetadataSchema: Schema =  {
    struct: {
